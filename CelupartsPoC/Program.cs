...
var configurationForGoogle = builder.Configuration;

builder.Services.AddAuthentication().AddGoogle(googleOptions =>
{
    googleOptions.ClientId = configurationForGoogle["Authentication:Google:ClientId"];
    googleOptions.ClientSecret = configurationForGoogle["Authentication:Google:ClientSecret"];
});
